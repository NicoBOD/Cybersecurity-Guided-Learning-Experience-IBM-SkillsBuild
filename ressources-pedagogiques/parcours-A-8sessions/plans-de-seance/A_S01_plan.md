...
- [x] Supports de présentation (Slides S01)
- [x] Fiche d'activité A_S01 (Scénarios CIA)
- [x] Script de démo OSINT simplifiée (dans `A_scripts_demo.md`)
- [x] Outil de sondage interactif configuré (Sondage "Actif le plus précieux")
- [x] Support complet de cours en format `.MD` (`A_S01_support.md`)
