...
1.  **Parcours A (Accompagnement court)** : 8 sessions de 1h30 (total 12 heures).
...
*   **Plans de séance** : Les 8 plans de séance complets ont été rédigés et validés dans `docs/ressources-pedagogiques/parcours-A-8sessions/plans-de-seance/`.
*   **Supports de cours (.MD)** : Les 8 supports de cours correspondants ont été rédigés selon le Gabarit 5.2 et validés dans `docs/ressources-pedagogiques/parcours-A-8sessions/supports-md/`.
...
*   **Plans de séance** : Les plans de séance de B01 à B20 ont été créés et stockés dans `docs/ressources-pedagogiques/parcours-B-20sessions/plans-de-seance/`.
*   **Supports de cours (.MD)** :
    *   **Lot 1 (Session B01 à B04 - Fondations)** : Rédigés et stockés dans `docs/ressources-pedagogiques/parcours-B-20sessions/supports-md/`.
    ...
    *   **Lot 2 (Session B05 à B08 - Systèmes & réseaux)** : Rédigés et stockés dans `docs/ressources-pedagogiques/parcours-B-20sessions/supports-md/`.
    ...
    *   **Lot 3 (Session B09 à B12 - Identités, cloud & données)** : Rédigés et stockés dans `docs/ressources-pedagogiques/parcours-B-20sessions/supports-md/`.
    ...
    *   **Lot 4 (Session B13 à B16 - Gouvernance, risque & conformité)** : Rédigés et stockés dans `docs/ressources-pedagogiques/parcours-B-20sessions/supports-md/`.
    ...
    *   **Lot 5 (Session B17 à B20 - Opérations, détection & réponse)** : Rédigés et stockés dans `docs/ressources-pedagogiques/parcours-B-20sessions/supports-md/`.
        ...
        *   `B_S20_support.md` (Grand Atelier d'Audit & Clôture — atelier interactif MedDistri)
...
## 3. Structure des fichiers dans le dépôt
```text
docs/
├── documents-de-travail/                          # Fichiers de cadrage (exclus du site publié)
...
└── ressources-pedagogiques/
    ...
    │   ├── plans-de-seance/                       # A_S01_plan.md à A_S08_plan.md
    │   ├── projet/                                # A_capstone.md (Atelier d'Audit Interactif MedDistri)
    │   ├── slides/                                # A_S01_slides_spec.md à A_S08_slides_spec.md
    │   └── supports-md/                           # A_S01_support.md à A_S08_support.md
    └── parcours-B-20sessions/
        ├── outils/                                # B_banque_quiz.md, B_scripts_demo.md, B_messages.md
        ├── plans-de-seance/                       # B_S01_plan.md à B_S20_plan.md
        ├── projet/                                # B_capstone.md, B_miniprojets.md
        ├── slides/                                # B_S01_slides_spec.md à B_S20_slides_spec.md
        └── supports-md/                           # B_S01_support.md à B_S20_support.md
```
